...
![](viz_iI_files/figure-gfm/unnamed-chunk-11-1.png)<!-- --> What happen
when you want multipanel plots but can’t facet…?
...
![](viz_iI_files/figure-gfm/unnamed-chunk-12-3.png)<!-- --> \#\# Data
Manipulation

Control your facotrs…
...
![](viz_iI_files/figure-gfm/unnamed-chunk-13-1.png)<!-- --> What if I
wanted densities for tmin and tmax simultaneously?
...
``` r
litters_data <-
  read_csv("./results/FAS_litters.csv") %>% 
  janitor::clean_names() %>% 
